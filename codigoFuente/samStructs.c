...
/* Aquí se implementa la librería samStructs.h del programa, que contiene estructuras y enumeradores para los formularios y opciones de los menús del software */